...
### Cursor
<img src="https://cursor.com/deeplink/mcp-install-dark.png" alt="Add norman-finance-mcp MCP server to Cursor" style="max-height: 32px;" />

**To add the MCP server to Cursor, copy and paste this link into your browsr:**
